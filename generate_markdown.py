...
TIR_BASE_URL = "https://thor-gpu.e2enetworks.net"  # "https://gpu-notebooks.e2enetworks.com"
TOP_K = 15
...
def tir_url(url: str) -> str:
    ...
    return f'[![Open In TIR](images/open_in_tir.png)]({url})'
...
def generate_markdown():
    ...
    with open('README.md', 'w', encoding='utf-8') as f:
        # print('[![Hits](https://hits.seeyoufarm.com/api/count/incr/badge.svg?url=https://github.com/e2eterraformprovider/e2e-notebook-collection)](https://hits.seeyoufarm.com)', file=f)
        ...
        # print('\n[![Stargazers over time](https://starchart.cc/e2eterraformprovider/e2e-notebook-collection.svg)](https://starchart.cc/e2eterraformprovider/e2e-notebook-collection)', file=f)
